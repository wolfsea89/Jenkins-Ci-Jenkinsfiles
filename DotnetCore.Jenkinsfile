                  ...
                  steps{
                    script{
                      if(facts.dotnetCoreDisableUnitTest == false){
                        ...
                        unitTests.setParameters('--verbosity normal --logger "trx" --settings CodeCoverage.runsettings --CollectCoverage "true" --CoverletOutputFormat "cobertura" --CoverletOutput "TestResults/Coverage/"')
