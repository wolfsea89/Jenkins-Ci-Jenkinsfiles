                  ...
                  steps{
                    script{
                      if(facts.dotnetCoreDisableUnitTest == false){
                        ...
                        unitTests.setParameters('--verbosity normal --logger "trx" --settings CodeCoverage.runsettings /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura /p:CoverletOutput=TestResults/Coverage/')
