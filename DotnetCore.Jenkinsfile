                  ...
                  steps{
                    script{
                      if(facts.dotnetCoreDisableUnitTest == false){
                        ...
                        unitTests.setParameters('--verbosity normal --logger "trx" --collect:"Code Coverage" /p:CollectCoverage=true /p:CoverletOutputFormat=cobertura /p:CoverletOutput=TestResults/Coverage/')
